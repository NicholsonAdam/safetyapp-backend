...
// Catch unhandled promise rejections so they don't silently die
...
app.use(
  cors({
    origin: process.env.FRONTEND_URL || "https://safetyapp-frontend.onrender.com",
...
// Single file serving route for uploads
...
// CRON — wrapped so a startup failure doesn't crash the server
try {
