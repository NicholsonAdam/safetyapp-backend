...
// Footer (split: left text, right page number)
function drawFooter(doc) {
  const y = doc.page.height - 40;

  doc.fontSize(9)
     .fillColor("#555555")
     .text("Generated by Dal‑Tile Safety App — Muskogee Operations", 40, y, {
       align: "left"
     });

  doc.fontSize(9)
     .fillColor("#555555")
     .text(`Page ${doc.page.number}`, -40, y, {
       align: "right"
     });
  ...
  try {
    ...
    if (photoPath) {
      ...
      try {
        ...
        doc.font("Helvetica")
           .fontSize(12)
           .text("Photo could not be rendered.");
      }
    ...
    // When PDF is finished writing, insert into DB
